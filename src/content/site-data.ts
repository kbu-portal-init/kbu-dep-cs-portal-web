...
export const resources: Resource[] = [
  {
    id: "student-benefits",
    title: "Student Benefits & Tech Packs",
    description:
      "Exclusive software, cloud credits, AI tools, and developer packs available free for all enrolled KBU students.",
    href: "/resources/student-benefits",
    label: "Claim student perks",
    image: placeholderImage,
  },
  {
    id: "courses",
...
export const studentEmailGuide = {
  ...
  steps: [
    {
      ...
      detail:
        "Navigate to https://outlook.cloud.microsoft/mail/ or portal.office.com using any modern browser.",
    },
    {
      stepNumber: "02",
      title: "Enter Your KBU Email",
      detail:
        "Input your student email address formatted as u[StudentID]@ms.kbu.ac.th (for example: u66130500123@ms.kbu.ac.th).",
    },
    {
      stepNumber: "03",
      title: "Use Your Microsoft Teams Password",
      detail:
        "Enter your password — this is the exact same password you use to log in to your Microsoft Teams account for university classes.",
    },
    {
      stepNumber: "04",
      title: "Check Inbox & Verification Links",
      detail:
        "When applying for developer packs (GitHub, Figma, AWS, JetBrains), verification links and codes will arrive in this Outlook inbox.",
    },
  ],
  tips: [
...
export const studentBenefits: StudentBenefit[] = [
  {
    ...
    eligibility:
      "Enrolled KBU student with an active @ms.kbu.ac.th email or valid student ID card.",
    howToClaim: [
  ...
  },
  {
    ...
    valueBadge: "THB 0 / mo",
    pricingNote:
      "THB 0 per month for 12 months, instead of THB 189/mo (THB 189/mo after 12 months).",
    postedDate: "13 September 2026",
    restrictionsNote:
  ...
  },
  {
    ...
    pricingNote:
      "100% Free for verified students via SheerID — no credit card required at any step.",
    postedDate: "13 September 2026",
    perks: [
